...
- (UIButton *)leftBtn {
    if (!_leftBtn) {
        ...
        _leftBtn.titleLabel.font = [UIFont customFontWithSize:self.manager.leftBtnTitleSize];
...
- (UIButton *)rightBtn {
    if (!_rightBtn) {
        ...
        _rightBtn.titleLabel.font = [UIFont customFontWithSize:self.manager.rightBtnTitleSize];
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.font = [UIFont customFontWithSize:self.manager.titleSize];
