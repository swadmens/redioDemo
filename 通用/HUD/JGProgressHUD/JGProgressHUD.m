...
//        else {
            ...
            if (self.style == JGProgressHUDStyleDark) {
                _HUDView.backgroundColor = [UIColor colorWithWhite:0.0f alpha:0.65f];
            }
            else if (self.style == JGProgressHUDStyleLight) {
                _HUDView.backgroundColor = [UIColor colorWithWhite:1.0f alpha:0.0f];
            }
            else {
...
- (UILabel *)textLabel {
    if (!_textLabel) {
        ...
        _textLabel.font = [UIFont boldSystemFontOfSize:kFontSizeFifty];
...
- (UILabel *)detailTextLabel {
    if (!_detailTextLabel) {
        ...
        _detailTextLabel.font = [UIFont customFontWithSize:13.0f];
