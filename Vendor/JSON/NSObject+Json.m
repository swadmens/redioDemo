...
//    for (EmojInfo *info in arraydict ) {
...
//
//
//        [dic setObject:info.emjStr forKey:@"emojiTag"];
//        [dic setObject:@(info.index) forKey:@"emojiIndex"];
//
//
//
//        if (dic) {
...
- (id)serializeToJsonObject
{
    ...
    DLog(@"[%@] can't convert to vaild Json", self);
    return nil;
}
