...
@property (nonatomic, strong) JXSheetModel *titleModel;
@property (nonatomic, strong) JXSheetModel *cancelModel;
...
@property (nonatomic, copy) JXSheetCompletionHanlde completionHanlde;
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _titleFont = [UIFont customFontWithSize:14.];
        _otherTitlesFont = [UIFont customFontWithSize:18.];
...
- (void)showView {
    ...
    frame.origin.x = (CGRectGetWidth(statusBarWindow.bounds) - CGRectGetWidth(self.bounds))/2.0;
    frame.origin.y = (CGRectGetHeight(statusBarWindow.bounds) - CGRectGetHeight(self.bounds))/2.0;
    self.frame = frame;
